...
class Database{
     ...
     *
	 * @param $param string is the placeholder value that we will be using in our SQL statement, example :name.
	 * @param $value string is the actual value that we want to bind to the placeholder, example “John Smith”.
	 * @param $type string is the datatype of the parameter, example string.
     */
